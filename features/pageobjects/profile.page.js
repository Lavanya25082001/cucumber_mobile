...
class ProfilePage {
  locators = {
    android: {
      ...
      userName:"//android.widget.TextView[@resource-id='com.booking:id/facet_profile_header_name']",
   manageAccount:'//android.widget.TextView[@text="Manage your account"]',
   displayName:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_public_detail_user_name"]',
DOB:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_public_detail_user_dob"]',
firstName:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_first_name"]',
lastName:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_last_name"]',
mobilenumber:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_phone"]',
city:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_city"]',
pincode:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_postcode"]',
	business:'//android.widget.Switch[@resource-id="com.booking:id/edit_profile_personal_detail_business_switch"]',
companyName:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_name"]',
companyAddress:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_address"]',
companyCity:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_city"]',   
companyCountry:'//android.widget.AutoCompleteTextView[@resource-id="com.booking:id/edit_profile_personal_detail_company_country"]',
companyPincode:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_postcode"]',
companyNumber:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_phone"]',
companyVAT:'//android.widget.EditText[@resource-id="com.booking:id/edit_profile_personal_detail_company_vat"]',
signOut:'//android.widget.Button[@resource-id="com.booking:id/edit_profile_sign_off_action"]',
confirmSignout:'//android.widget.Button[@resource-id="android:id/button1"]',
